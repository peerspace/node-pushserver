...
app.use(logger.assignLogKey());
app.use(logger.middleware(['/uptest', '/status', '/admin/entities']));
...
app.post('/subscribe', function (req, res) {
    if (req.body.subscriptionId) {
        logger.INFO('REQUEST', 'Redirecting to push-notification-2', '', { body: req.body }, 0);
        oneSignal.subscribeCallbackFunc(req.body, (response) => {   
