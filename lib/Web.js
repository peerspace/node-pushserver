...
function sendNotifications(notifs) {
    ...
    console.log("NOTIFICATIONS", notifs, areNotificationsValid);
    ...
    notifs.forEach(function (notif) {
        ...
        if (androidPayload) {
            console.log("REDIRECTING TO TWILIO-NOTIFICATIONS:", androidPayload);
...
function redirectToTwilio(androidPayload) {
    ...
    const req = http.request(request_params, res => {
        console.log(`TWILIO NOTIFICATIONS RESPONSE: ${res}`);
    });
