...
exports.subscribe = function (payload) {
  ...
  console.log('------------------------REQUEST PARAMS--1-------------------------',config.push_notifications_2_host);

  console.log('------------------------REQUEST PARAMS--2-------------------------',config.push_notifications_2_port);

  console.log('------------------------REQUEST PARAMS---------------------------',JSON.stringify(request_params));
